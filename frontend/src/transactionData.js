...
export const ACCOUNTS = [
  { id: 'acct-4471', orgId: 'academy-mortgage', name: 'Academy Mortgage — Denver', initial: 'D', color: '#2a78d6', verifiedUsers: 214, trend: 'down' },
  { id: 'acct-2290', orgId: 'summit-lending', name: 'Summit Lending — Austin', initial: 'A', color: '#1baf7a', verifiedUsers: 156, trend: 'up' },
  { id: 'acct-6603', orgId: 'harbor-financial', name: 'Harbor Financial — Boise', initial: 'B', color: '#4a3aa7', verifiedUsers: 88, trend: 'up' },
]
